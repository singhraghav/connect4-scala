...
case class Board(grid: ArrayBuffer[ArrayBuffer[String]], rowValueWherePieceWillLand: Map[Column, Int], boardHeight: Int, boardLength: Int) {
...
object Board {
  ...
  def apply(): Board = {
    ...
    new Board(grid, rowValueWherePieceWillLand, boardHeight = 6, boardLength = 7)
  }
}
